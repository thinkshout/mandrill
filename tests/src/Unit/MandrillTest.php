...
/**
 * @file
 * Contains \Drupal\Tests\mandrill\MandrillTest.
 */
namespace Drupal\Tests\mandrill\Unit;
...
class MandrillTest extends UnitTestCase {
  /**
   * Modules to enable.
   *
   * @var array
  ...
  protected function setUp() {
    ...
    $this->configFactory = $this->getConfigFactoryStub(array(
      'mandrill.settings' => array(
        'defaults' => array(
        ),
      ),
    ));

    $this->configFactory->set('from_email', 'foo@bar.com');
...
/*    $mailSystem = $this->getMandrillMail();
    ...
    $response = 'Tested sending message to multiple recipients.';
